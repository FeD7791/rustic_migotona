...
function loader() {
  ...
  for (let j = 0; j < product_array.length; j++) {
    ...
    element_p_tag.textContent =
      product_array[j].nombre + " x " + product_array[j].cantidad;
    element_p_tag_2.textContent =
      "Total: " + product_array[j].cantidad * product_array[j].precio;
