...
const user_database = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "../database/users_database.json"))
);
...
module.exports = { add_user, user_filter, user_database };
